...
// human hearing is exponential, so this is too. 25 db range from 1 to 255, so
// ~0.1 decibels per

/*
* Generated using the following D program (don't judge me, it's what I use
instead of python)
*   import std.math : pow;
...
constexpr static float volume_lookup[256] = {
    0.0f,        0.00323448f, 0.00330832f, 0.00338386f, 0.00346111f,
    0.00354013f, 0.00362096f, 0.00370363f, 0.00378819f, 0.00387468f,
    0.00396314f, 0.00405362f, 0.00414617f, 0.00424083f, 0.00433765f,
    0.00443669f, 0.00453798f, 0.00464159f, 0.00474756f, 0.00485595f,
    0.00496682f, 0.00508022f, 0.0051962f,  0.00531484f, 0.00543618f,
    0.0055603f,  0.00568725f, 0.00581709f, 0.0059499f,  0.00608574f,
    0.00622469f, 0.00636681f, 0.00651217f, 0.00666085f, 0.00681292f,
    0.00696847f, 0.00712756f, 0.00729029f, 0.00745674f, 0.00762699f,
    0.00780112f, 0.00797923f, 0.0081614f,  0.00834773f, 0.00853832f,
    0.00873326f, 0.00893265f, 0.00913659f, 0.00934519f, 0.00955855f,
    0.00977679f, 0.01f,       0.0102283f,  0.0104618f,  0.0107007f,
    0.010945f,   0.0111949f,  0.0114505f,  0.0117119f,  0.0119793f,
    0.0122528f,  0.0125325f,  0.0128187f,  0.0131113f,  0.0134107f,
    0.0137169f,  0.01403f,    0.0143504f,  0.014678f,   0.0150131f,
    0.0153559f,  0.0157065f,  0.0160651f,  0.0164318f,  0.016807f,
    0.0171907f,  0.0175832f,  0.0179846f,  0.0183953f,  0.0188152f,
    0.0192448f,  0.0196842f,  0.0201336f,  0.0205933f,  0.0210634f,
    0.0215443f,  0.0220362f,  0.0225393f,  0.0230539f,  0.0235803f,
    0.0241186f,  0.0246693f,  0.0252325f,  0.0258086f,  0.0263979f,
    0.0270005f,  0.027617f,   0.0282475f,  0.0288924f,  0.0295521f,
    0.0302268f,  0.0309169f,  0.0316228f,  0.0323448f,  0.0330832f,
    0.0338386f,  0.0346111f,  0.0354013f,  0.0362096f,  0.0370363f,
    0.0378819f,  0.0387468f,  0.0396314f,  0.0405362f,  0.0414617f,
    0.0424083f,  0.0433765f,  0.0443669f,  0.0453798f,  0.0464159f,
    0.0474756f,  0.0485595f,  0.0496682f,  0.0508022f,  0.0519621f,
    0.0531484f,  0.0543618f,  0.055603f,   0.0568725f,  0.0581709f,
    0.059499f,   0.0608574f,  0.0622469f,  0.063668f,   0.0651217f,
    0.0666085f,  0.0681292f,  0.0696847f,  0.0712757f,  0.0729029f,
    0.0745674f,  0.0762699f,  0.0780112f,  0.0797923f,  0.081614f,
    0.0834773f,  0.0853832f,  0.0873326f,  0.0893265f,  0.0913659f,
    0.0934519f,  0.0955855f,  0.0977679f,  0.1f,        0.102283f,
    0.104618f,   0.107007f,   0.10945f,    0.111949f,   0.114505f,
    0.117119f,   0.119793f,   0.122528f,   0.125325f,   0.128187f,
    0.131113f,   0.134107f,   0.137169f,   0.1403f,     0.143504f,
    0.14678f,    0.150131f,   0.153559f,   0.157065f,   0.160651f,
    0.164318f,   0.16807f,    0.171907f,   0.175832f,   0.179846f,
    0.183953f,   0.188152f,   0.192448f,   0.196842f,   0.201336f,
    0.205933f,   0.210634f,   0.215443f,   0.220362f,   0.225393f,
    0.230539f,   0.235803f,   0.241186f,   0.246693f,   0.252325f,
    0.258086f,   0.263979f,   0.270005f,   0.27617f,    0.282475f,
    0.288924f,   0.295521f,   0.302268f,   0.309169f,   0.316228f,
    0.323448f,   0.330832f,   0.338386f,   0.346111f,   0.354013f,
    0.362096f,   0.370363f,   0.378819f,   0.387468f,   0.396314f,
    0.405362f,   0.414617f,   0.424083f,   0.433765f,   0.443669f,
    0.453798f,   0.464159f,   0.474756f,   0.485595f,   0.496682f,
    0.508022f,   0.51962f,    0.531484f,   0.543618f,   0.55603f,
    0.568725f,   0.581709f,   0.59499f,    0.608574f,   0.622469f,
    0.636681f,   0.651217f,   0.666085f,   0.681292f,   0.696847f,
    0.712756f,   0.729029f,   0.745674f,   0.762699f,   0.780112f,
    0.797923f,   0.81614f,    0.834773f,   0.853832f,   0.873326f,
    0.893265f,   0.913659f,   0.934519f,   0.955855f,   0.977679f,
    1.0f};

class musicsound_info // composition makes it at least a little easier to just
                      // "plug in" new systems here
{
#ifndef WIN32
...
public:
  bool is_ambience_playing(int32_t ambience_active_channel) {
    return is_ambience_playing_ptr(ambience_active_channel);
  }
  ...
  void stop_ambience(int32_t ambience_active_channel) {
    stop_ambience_ptr(ambience_active_channel);
  }
  ...
  void play_ambience(int32_t new_ambience, int32_t ambience_active_channel) {
    play_ambience_ptr(new_ambience, ambience_active_channel);
  }

  void play_sound(int s, int32_t vol, bool use_media_sound_volume) {
    play_sound_ptr(s, vol, use_media_sound_volume);
  }

  bool set_song(const std::string& filename, int slot, bool loops = false) {
    return set_song_ptr(filename, slot, loops);
  }

  bool set_sound(const std::string& filename, int slot) {
    return set_sound_ptr(filename, slot);
  }

  void set_init_volumes(int master_volume, int sfx_volume, int ambience_volume,
                        int music_volume) {
    set_init_volumes_ptr(master_volume, sfx_volume, ambience_volume,
                         music_volume);
  }
  ...
  void set_ambience_volume(int32_t chan, float vol) {
    set_ambience_volume_ptr(chan, vol);
  }
...
public:
  ...
  void set_custom_song(std::string& token, std::string& filename,
                       std::string& title, std::string& author, bool loops);
