...
void keybinding_init() {
	...
	*/
	...
	bindingNames.insert(INTERFACEKEY_CONTEXT_SCROLL_UP, "CONTEXT_SCROLL_UP");
	bindingNames.insert(INTERFACEKEY_CONTEXT_SCROLL_DOWN, "CONTEXT_SCROLL_DOWN");
	bindingNames.insert(INTERFACEKEY_CONTEXT_SCROLL_PAGEUP, "CONTEXT_SCROLL_PAGEUP");
	bindingNames.insert(INTERFACEKEY_CONTEXT_SCROLL_PAGEDOWN, "CONTEXT_SCROLL_PAGEDOWN");
	/*
	...
	*/
	...
	bindingNames.insert(INTERFACEKEY_CURSOR_UP_Z_FAST, "CURSOR_UP_Z_FAST");
	bindingNames.insert(INTERFACEKEY_CURSOR_DOWN_Z_FAST, "CURSOR_DOWN_Z_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP, "KEYBOARD_CURSOR_UP");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN, "KEYBOARD_CURSOR_DOWN");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_LEFT, "KEYBOARD_CURSOR_LEFT");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_RIGHT, "KEYBOARD_CURSOR_RIGHT");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPLEFT, "KEYBOARD_CURSOR_UPLEFT");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPRIGHT, "KEYBOARD_CURSOR_UPRIGHT");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNLEFT, "KEYBOARD_CURSOR_DOWNLEFT");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNRIGHT, "KEYBOARD_CURSOR_DOWNRIGHT");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP_FAST, "KEYBOARD_CURSOR_UP_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN_FAST, "KEYBOARD_CURSOR_DOWN_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_LEFT_FAST, "KEYBOARD_CURSOR_LEFT_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_RIGHT_FAST, "KEYBOARD_CURSOR_RIGHT_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPLEFT_FAST, "KEYBOARD_CURSOR_UPLEFT_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPRIGHT_FAST, "KEYBOARD_CURSOR_UPRIGHT_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNLEFT_FAST, "KEYBOARD_CURSOR_DOWNLEFT_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNRIGHT_FAST, "KEYBOARD_CURSOR_DOWNRIGHT_FAST");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP_Z, "KEYBOARD_CURSOR_UP_Z");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN_Z, "KEYBOARD_CURSOR_DOWN_Z");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP_Z_AUX, "KEYBOARD_CURSOR_UP_Z_AUX");
	bindingNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN_Z_AUX, "KEYBOARD_CURSOR_DOWN_Z_AUX");
	/*
	...
	*/
	...
	bindingNames.insert(INTERFACEKEY_HOTKEY_BUILDING_FURNITURE, "HOTKEY_BUILDING_FURNITURE");
	bindingNames.insert(INTERFACEKEY_HOTKEY_BUILDING_PORTALS, "HOTKEY_BUILDING_PORTALS");
	bindingNames.insert(INTERFACEKEY_HOTKEY_BUILDING_CAGES_CHAINS, "HOTKEY_BUILDING_CAGES_CHAINS");
	bindingNames.insert(INTERFACEKEY_HOTKEY_BUILDING_MILITARY, "HOTKEY_BUILDING_MILITARY");
	bindingNames.insert(INTERFACEKEY_HOTKEY_BUILDING_WORKSHOPS_CLOTHING_LEATHER, "HOTKEY_BUILDING_WORKSHOPS_CLOTHING_LEATHER");
	bindingNames.insert(INTERFACEKEY_HOTKEY_BUILDING_FARMING, "HOTKEY_BUILDING_FARMING");
	...
	*/
	...
	bindingNames.insert(INTERFACEKEY_D_TOGGLE_RAMP_INDICATORS, "D_TOGGLE_RAMP_INDICATORS");
	bindingNames.insert(INTERFACEKEY_D_TOGGLE_FLUID_NUMBERS, "D_TOGGLE_FLUID_NUMBERS");

	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_DIG, "D_DESIGNATE_DIG");
	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_CHOP, "D_DESIGNATE_CHOP");
	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_GATHER, "D_DESIGNATE_GATHER");
	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_SMOOTH, "D_DESIGNATE_SMOOTH");
	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_ITEMS, "D_DESIGNATE_ITEMS");
	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_TRAFFIC, "D_DESIGNATE_TRAFFIC");
	bindingNames.insert(INTERFACEKEY_D_DESIGNATE_ERASE, "D_DESIGNATE_ERASE");
	...
	bindingNames.insert(INTERFACEKEY_D_LABOR, "D_LABOR");
	...
	bindingNames.insert(INTERFACEKEY_D_WORLD, "D_WORLD");
	bindingNames.insert(INTERFACEKEY_D_JUSTICE, "D_JUSTICE");

	bindingNames.insert(INTERFACEKEY_D_STOCKS, "D_STOCKS");

	bindingNames.insert(INTERFACEKEY_ARENA_CREATE_CREATURE, "ARENA_CREATE_CREATURE");
	bindingNames.insert(INTERFACEKEY_ARENA_CREATURE_RESET, "ARENA_CREATURE_RESET");
	bindingNames.insert(INTERFACEKEY_ARENA_FLUIDS, "ARENA_FLUIDS");
	bindingNames.insert(INTERFACEKEY_ARENA_FLUIDS_WATER, "ARENA_FLUIDS_WATER");
	bindingNames.insert(INTERFACEKEY_ARENA_FLUIDS_MAGMA, "ARENA_FLUIDS_MAGMA");
	bindingNames.insert(INTERFACEKEY_ARENA_FLUIDS_SNOW, "ARENA_FLUIDS_SNOW");
	bindingNames.insert(INTERFACEKEY_ARENA_FLUIDS_MUD, "ARENA_FLUIDS_MUD");
	bindingNames.insert(INTERFACEKEY_ARENA_FLUIDS_REMOVE, "ARENA_FLUIDS_REMOVE");
	bindingNames.insert(INTERFACEKEY_ARENA_CREATE_TREE, "ARENA_CREATE_TREE");
	...
	*/
	...
	bindingNames.insert(INTERFACEKEY_DESIGNATE_RECTANGLE, "DESIGNATE_RECTANGLE");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_FREE_DRAW, "DESIGNATE_FREE_DRAW");

	bindingNames.insert(INTERFACEKEY_DESIGNATE_TOGGLE_ADVANCED_OPTIONS, "DESIGNATE_TOGGLE_ADVANCED_OPTIONS");

	bindingNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_ALL, "DESIGNATE_MINE_MODE_ALL");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_AUTO, "DESIGNATE_MINE_MODE_AUTO");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_ORE_GEM, "DESIGNATE_MINE_MODE_ORE_GEM");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_GEM, "DESIGNATE_MINE_MODE_GEM");

	bindingNames.insert(INTERFACEKEY_DESIGNATE_PRIORITY_UP, "DESIGNATE_PRIORITY_UP");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_PRIORITY_DOWN, "DESIGNATE_PRIORITY_DOWN");

	bindingNames.insert(INTERFACEKEY_DESIGNATE_TOGGLE_MARKER, "DESIGNATE_TOGGLE_MARKER");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_MARKER_TO_STANDARD, "DESIGNATE_MARKER_TO_STANDARD");
	bindingNames.insert(INTERFACEKEY_DESIGNATE_STANDARD_TO_MARKER, "DESIGNATE_STANDARD_TO_MARKER");
...
//	displayNames.insert(INTERFACEKEY_STANDARDSCROLL_RIGHT, "Move selector right");
	...
	displayNames.insert(INTERFACEKEY_CONTEXT_SCROLL_UP, "Mouse-context scrollbar up");
	displayNames.insert(INTERFACEKEY_CONTEXT_SCROLL_DOWN, "Mouse-context scrollbar down");
	displayNames.insert(INTERFACEKEY_CONTEXT_SCROLL_PAGEUP, "Mouse-context scrollbar page up");
	displayNames.insert(INTERFACEKEY_CONTEXT_SCROLL_PAGEDOWN, "Mouse-context scrollbar page down");
	/*
	...
	*/
	...
	displayNames.insert(INTERFACEKEY_CURSOR_UP_Z_FAST, "Move view/cursor up (z), fast");
	displayNames.insert(INTERFACEKEY_CURSOR_DOWN_Z_FAST, "Move view/cursor down (z), fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP, "Move keyboard cursor up");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN, "Move keyboard cursor down");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_LEFT, "Move keyboard cursor left");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_RIGHT, "Move keyboard cursor right");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPLEFT, "Move keyboard cursor up and left");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPRIGHT, "Move keyboard cursor up and right");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNLEFT, "Move keyboard cursor down and left");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNRIGHT, "Move keyboard cursor down and right");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP_FAST, "Move keyboard cursor up, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN_FAST, "Move keyboard cursor down, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_LEFT_FAST, "Move keyboard cursor left, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_RIGHT_FAST, "Move keyboard cursor right, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPLEFT_FAST, "Move keyboard cursor up and left, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UPRIGHT_FAST, "Move keyboard cursor up and right, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNLEFT_FAST, "Move keyboard cursor down and left, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWNRIGHT_FAST, "Move keyboard cursor down and right, fast");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP_Z, "Move keyboard cursor up (z)");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN_Z, "Move keyboard cursor down (z)");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_UP_Z_AUX, "Move keyboard cursor up (z), aux");
	displayNames.insert(INTERFACEKEY_KEYBOARD_CURSOR_DOWN_Z_AUX, "Move keyboard cursor down (z), aux");
	/*
	...
	*/
	...
	displayNames.insert(INTERFACEKEY_HOTKEY_BUILDING_FURNITURE, "Hotkey: Building, Furniture");
	displayNames.insert(INTERFACEKEY_HOTKEY_BUILDING_PORTALS, "Hotkey: Building, Doors and Hatches");
	displayNames.insert(INTERFACEKEY_HOTKEY_BUILDING_CAGES_CHAINS, "Hotkey: Building, Cages and Chains");
	displayNames.insert(INTERFACEKEY_HOTKEY_BUILDING_MILITARY, "Hotkey: Building, Military");
	displayNames.insert(INTERFACEKEY_HOTKEY_BUILDING_WORKSHOPS_CLOTHING_LEATHER, "Hotkey: Building, Workshops, Cloth/Leather");
	displayNames.insert(INTERFACEKEY_HOTKEY_BUILDING_FARMING, "Hotkey: Building, Workshops, Farming");
	...
	*/
	...
	displayNames.insert(INTERFACEKEY_D_TOGGLE_RAMP_INDICATORS, "Main: Toggle ramp indicators");
	displayNames.insert(INTERFACEKEY_D_TOGGLE_FLUID_NUMBERS, "Main: Toggle fluid numbers");

	displayNames.insert(INTERFACEKEY_D_DESIGNATE_DIG, "Main: Dig");
	displayNames.insert(INTERFACEKEY_D_DESIGNATE_CHOP, "Main: Chop tress");
	displayNames.insert(INTERFACEKEY_D_DESIGNATE_GATHER, "Main: Gather plants");
	displayNames.insert(INTERFACEKEY_D_DESIGNATE_SMOOTH, "Main: Smooth and engrave");
	displayNames.insert(INTERFACEKEY_D_DESIGNATE_ITEMS, "Main: Item properties");
	displayNames.insert(INTERFACEKEY_D_DESIGNATE_TRAFFIC, "Main: Traffic designations");
	displayNames.insert(INTERFACEKEY_D_DESIGNATE_ERASE, "Main: Erase designations");

	displayNames.insert(INTERFACEKEY_D_BUILDING, "Main: Buildings");
	displayNames.insert(INTERFACEKEY_D_STOCKPILES, "Main: Stockpiles");
	displayNames.insert(INTERFACEKEY_D_CIVZONE, "Main: Zones");
	displayNames.insert(INTERFACEKEY_D_BURROWS, "Main: Burrows");
	displayNames.insert(INTERFACEKEY_D_HAULING, "Main: Hauling");

	displayNames.insert(INTERFACEKEY_D_UNITLIST, "Main: Units");
	displayNames.insert(INTERFACEKEY_D_JOBLIST, "Main: Tasks");
	displayNames.insert(INTERFACEKEY_D_LOCATIONS, "Main: Locations");
	displayNames.insert(INTERFACEKEY_D_LABOR, "Main: Labor");
	displayNames.insert(INTERFACEKEY_D_ORDERS, "Main: Work orders");
	displayNames.insert(INTERFACEKEY_D_NOBLES, "Main: Nobles");
	displayNames.insert(INTERFACEKEY_D_ARTLIST, "Main: Artifacts");
	displayNames.insert(INTERFACEKEY_D_SQUADS, "Main: Squads");
	displayNames.insert(INTERFACEKEY_D_WORLD, "Main: World");
	displayNames.insert(INTERFACEKEY_D_JUSTICE, "Main: Justice");

	displayNames.insert(INTERFACEKEY_D_STOCKS, "Main: Stocks");

	displayNames.insert(INTERFACEKEY_ARENA_CREATE_CREATURE, "Arena: Create creature");
	displayNames.insert(INTERFACEKEY_ARENA_CREATURE_RESET, "Arena: Creature, reset");
	displayNames.insert(INTERFACEKEY_ARENA_FLUIDS, "Arena: Fluids");
	displayNames.insert(INTERFACEKEY_ARENA_FLUIDS_WATER, "Arena: Fluids, water");
	displayNames.insert(INTERFACEKEY_ARENA_FLUIDS_MAGMA, "Arena: Fluids, magma");
	displayNames.insert(INTERFACEKEY_ARENA_FLUIDS_SNOW, "Arena: Fluids, snow");
	displayNames.insert(INTERFACEKEY_ARENA_FLUIDS_MUD, "Arena: Fluids, mud");
	displayNames.insert(INTERFACEKEY_ARENA_FLUIDS_REMOVE, "Arena: Fluids, remove");
	displayNames.insert(INTERFACEKEY_ARENA_CREATE_TREE, "Arena: Create tree");
	displayNames.insert(INTERFACEKEY_ARENA_WEATHER, "Arena: Weather");
	displayNames.insert(INTERFACEKEY_ARENA_CONFLICT_STATE_1, "Arena: Conflict state down");
	displayNames.insert(INTERFACEKEY_ARENA_CONFLICT_STATE_2, "Arena: Conflict state up");
	...
	*/
	...
	displayNames.insert(INTERFACEKEY_DESIGNATE_RECTANGLE, "Designate, Rectangle");
	displayNames.insert(INTERFACEKEY_DESIGNATE_FREE_DRAW, "Designate, Free Draw");

	displayNames.insert(INTERFACEKEY_DESIGNATE_TOGGLE_ADVANCED_OPTIONS, "Designate, Toggle Advanced Options");

	displayNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_ALL, "Designate, Mine All");
	displayNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_AUTO, "Designate, Mine Auto");
	displayNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_ORE_GEM, "Designate, Mine Ore+Gems");
	displayNames.insert(INTERFACEKEY_DESIGNATE_MINE_MODE_GEM, "Designate, Min Gems");

	displayNames.insert(INTERFACEKEY_DESIGNATE_PRIORITY_UP, "Designate, Priority Up");
	displayNames.insert(INTERFACEKEY_DESIGNATE_PRIORITY_DOWN, "Designate, Priority Down");

	displayNames.insert(INTERFACEKEY_DESIGNATE_TOGGLE_MARKER, "Designate, Toggle Blueprint");
	displayNames.insert(INTERFACEKEY_DESIGNATE_MARKER_TO_STANDARD, "Designate, Blueprint to Standard");
	displayNames.insert(INTERFACEKEY_DESIGNATE_STANDARD_TO_MARKER, "Designate, Standard to Blueprint");

	displayNames.insert(INTERFACEKEY_DESIGNATE_CHOP, "Designate, Chop Trees");

	displayNames.insert(INTERFACEKEY_DESIGNATE_PLANTS, "Designate, Gather Plants");
