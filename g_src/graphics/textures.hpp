...
class textures {
 ...
 public:
  ...
  void load_multi_pdim(const std::string &filename, svector<long> &tex_pos,long dimx,long dimy,
           bool convert_magenta,
           long *disp_x, long *disp_y);
  void load_multi_pdim(const std::string &filename,long *tex_pos,long dimx,long dimy,
           bool convert_magenta,
           long *disp_x, long *disp_y);
  void refresh_multi_pdim(const std::string &filename,svector<long> &tex_pos,long dimx,long dimy,
           bool convert_magenta);
